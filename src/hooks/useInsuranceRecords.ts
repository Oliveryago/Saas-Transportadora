...
export function useInsuranceRecords(vehicleId?: string, dateFilter?: DateFilter | null) {
    ...
    async function fetchRecords() {
        try {
            ...
            if (fromISO) query = query.gte("expiration_date", fromISO);
            if (toISO) query = query.lte("expiration_date", toISO);
